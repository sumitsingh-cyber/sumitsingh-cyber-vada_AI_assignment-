...
export default function HomeView() {
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-24 lg:pb-8">
      {/* Hero */}
      <div className="px-6 py-8 bg-gradient-to-br from-gray-900 to-gray-800 text-white mx-0">
        <div className="max-w-2xl">
          ...
          <h1 className="text-3xl font-bold mb-3">Welcome back, John Doe! 👋</h1>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold rounded-full hover:from-orange-600 hover:to-red-600 transition-all shadow-lg hover:shadow-xl"
          >
      ...
      <div className="px-6 py-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
          <button
            onClick={() => { resetForm(); setView('create-assignment'); }}
            className="flex items-center gap-4 p-5 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-orange-200 transition-all text-left group"
          >
          ...
          <button
            ...
            className="flex items-center gap-4 p-5 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all text-left group"
          >
          ...
          <button
            ...
            className="flex items-center gap-4 p-5 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-purple-200 transition-all text-left group"
          >
